...
const HARDCODED_GROUP_NAMES = [
    "CDN", "AI", "Telegram", "YouTube", "Bilibili", "Netflix", "Spotify",
...
function buildProxyGroups({ countries: t, countryProxyGroups: o, defaultProxies: n, defaultProxiesDirect: s, defaultFallback: i }) {
...
function main(e) {
    ...
    const u = buildProxyGroups({ countries: n, countryProxyGroups: p, defaultProxies: l, defaultProxiesDirect: i, defaultFallback: c });
