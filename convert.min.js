...
const TRAFFIC_KEYWORDS =
  /(建议|重置|官网|套餐|流量|剩余|到期|防丢|GB|导航|更新|Expire|Usage|Traffic|Standard|Used|Total)/i;
// 白名单：包含以下字符的依然视为普通节点
...
const staticRules = [
  ...
  "DOMAIN-SUFFIX,bahamut.akamaized.net,Bahamut",
  "DOMAIN-SUFFIX,gamer.com.tw,Bahamut",
  "DOMAIN-SUFFIX,hinet.net,Bahamut",
...
function buildProxyGroups({
  ...
  // AI 分组默认选择: Proxies 优先，其次是家宽节点
  const aiDefaultProxies = [PROXY_GROUPS.MANUAL, ...aiSpecificProxies];
